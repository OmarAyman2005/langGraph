...
def read_multiline_input() -> str:
    print("Manual Test: Full Normalizer + Parser 1 + LLM Response Generator + Parser 2 + Translator")
    print(
...
def main() -> None:
    ...
    print("Status: PASSED")
    print_json("\nParsed Problem:", parser_1_result["problem"])
    ...
    print("Status: PASSED")
    print_json("\nParsed Trace:", parser_2_result["trace"])
    ...
    print_json("\nSymbolic Problem:", translation_result["symbolic_problem"])
    print_json("\nSymbolic Trace:", translation_result["symbolic_trace"])
    print_json("\nProposition Map:", translation_result["proposition_map"])

    print("\nFull Translation Result:")
    print(pretty_json(translation_result))

    print("\nFinal Result: PASSED Full Normalizer + Parser 1 + LLM Response Generator + Parser 2 + Translator")
